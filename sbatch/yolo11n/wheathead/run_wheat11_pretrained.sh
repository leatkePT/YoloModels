#!/bin/bash
#SBATCH --job-name=Wh11_Pre
#SBATCH --partition=ampere
#SBATCH --gpus=1
#SBATCH --cpus-per-task=8
#SBATCH --ntasks=1
#SBATCH --time=06:00:00
#SBATCH --output=logs/yolo11n_logs/wheat11_pretrained_out_%j.txt
#SBATCH --error=logs/yolo11n_logs/wheat11_pretrained_error_%j.txt

echo "============================================================"
echo "🚀 ΕΚΚΙΝΗΣΗ JOB: YOLO11-Nano Global Wheat (Pretrained)"
echo "============================================================"
...
python3 -u server_training/wheat11_pretrained.py
