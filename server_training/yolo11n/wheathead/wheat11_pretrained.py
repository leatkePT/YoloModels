...
DATASET_NAME = "Global_Wheat_11n_Pretrained"
...
def compute_yolo11_loss(targets, model_outputs):
    ...
    for i, grid_pred in enumerate(model_outputs):
        ...
        # 2. Box & DFL Losses: Με MASK (υπολογίζονται ΜΟΝΟ εκεί που υπάρχουν πραγματικά στάχυα)
...
def train_yolo():
    ...
    LATEST_CHECKPOINT_PATH = f"{LOG_DIR}/wheat11_pretrain_latest_checkpoint.weights.h5"
    ...
    num_train_images = int(len(all_image_ids) * 0.8)
